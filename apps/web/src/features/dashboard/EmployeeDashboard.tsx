      ...
      <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-6 text-white shadow-lg shadow-blue-200">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`h-24 px-8 rounded-xl font-semibold text-2xl transition-all duration-200 active:scale-95 disabled:opacity-70 shadow-lg flex items-center justify-center gap-3 min-w-[180px] ${
              isClockedIn
