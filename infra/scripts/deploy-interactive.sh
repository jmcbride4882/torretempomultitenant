...
echo -e "${GREEN}╔══════════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${GREEN}║                                                                      ║${NC}"
echo -e "${GREEN}║              ${YELLOW}█████${NC}${GREEN}  TORRE TEMPO  ${YELLOW}█████${NC}${GREEN}                              ║${NC}"
echo -e "${GREEN}║                                                                      ║${NC}"
echo -e "${GREEN}║         ${BLUE}Professional Time Tracking & Labor Compliance${NC}${GREEN}          ║${NC}"
echo -e "${GREEN}║                                                                      ║${NC}"
echo -e "${GREEN}║              ${BLUE}by LSLT Group - Lakeside La Torre${NC}${GREEN}                   ║${NC}"
echo -e "${GREEN}║                                                                      ║${NC}"
echo -e "${GREEN}╚══════════════════════════════════════════════════════════════════════╝${NC}"
echo ""
echo -e "${BLUE}┌──────────────────────────────────────────────────────────────────────┐${NC}"
echo -e "${BLUE}│  ${NC}Welcome to the Torre Tempo Interactive Installation Wizard       ${BLUE}│${NC}"
echo -e "${BLUE}│  ${NC}This wizard will guide you through a complete deployment          ${BLUE}│${NC}"
echo -e "${BLUE}│  ${NC}                                                                  ${BLUE}│${NC}"
echo -e "${BLUE}│  ${NC}⏱️  Estimated time: 10-15 minutes                                 ${BLUE}│${NC}"
echo -e "${BLUE}│  ${NC}🔧 Requirements: Ubuntu 20.04+, Docker, root access               ${BLUE}│${NC}"
echo -e "${BLUE}│  ${NC}                                                                  ${BLUE}│${NC}"
echo -e "${BLUE}│  ${NC}Press ${YELLOW}Ctrl+C${NC} at any time to cancel                            ${BLUE}│${NC}"
echo -e "${BLUE}└──────────────────────────────────────────────────────────────────────┘${NC}"
echo ""
echo -e "  ${BLUE}Version:${NC} 1.0.0                    ${BLUE}Website:${NC} https://lsltgroup.es"
echo -e "  ${BLUE}Support:${NC} info@lsltgroup.es        ${BLUE}License:${NC} Commercial"
echo ""
...
echo -e "${YELLOW}╚══════════════════════════════════════════════════════════════════════╝${NC}"
echo ""
echo -e "${BLUE}Torre Tempo - Commercial Software License${NC}"
echo -e "${BLUE}Copyright © 2026 LSLT Group (Lakeside La Torre, Murcia)${NC}"
echo -e "${BLUE}All Rights Reserved.${NC}"
echo ""
echo -e "This is proprietary commercial software. By proceeding with this"
echo -e "installation, you acknowledge that:"
echo ""
echo -e "  ${GREEN}✓${NC} You have purchased a valid license from LSLT Group"
echo -e "  ${GREEN}✓${NC} You agree to the Terms and Conditions of Use"
echo -e "  ${GREEN}✓${NC} Unauthorized copying or distribution is prohibited"
echo -e "  ${GREEN}✓${NC} This software is provided 'as-is' without warranty"
echo ""
echo -e "${YELLOW}License Types:${NC}"
echo -e "  • Internal Use License (€199/month) - Single organization"
echo -e "  • Distribution License (€499/month) - Resell to clients"
echo -e "  • White Label License (Custom) - Full customization"
echo ""
echo -e "${BLUE}For licensing questions:${NC} info@lsltgroup.es | https://lsltgroup.es"
echo ""
echo -e "${RED}⚠️  WARNING: Proceeding without a valid license violates copyright law.${NC}"
echo ""
read -p "$(echo -e ${YELLOW}Do you have a valid license? Type \'yes\' to continue: ${NC})" license_accept
...
if [ "$license_accept" != "yes" ]; then
    ...
    echo -e "${RED}╚══════════════════════════════════════════════════════════════════════╝${NC}"
    echo ""
    echo -e "${YELLOW}  Torre Tempo requires a valid commercial license.${NC}"
    echo ""
    echo -e "${BLUE}  To purchase a license:${NC}"
    echo -e "    📧 Email:   info@lsltgroup.es"
    echo -e "    🌐 Website: https://lsltgroup.es"
    echo -e "    📞 Phone:   +34 XXX XXX XXX"
    echo ""
    echo -e "${YELLOW}  We offer:${NC}"
    echo -e "    • 30-day evaluation licenses (free)"
    echo -e "    • Volume discounts for multiple locations"
    echo -e "    • Custom development services"
    echo -e "    • Training and support packages"
    echo ""
    exit 0
fi
